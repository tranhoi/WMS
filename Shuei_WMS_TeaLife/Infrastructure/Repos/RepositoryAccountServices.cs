...
namespace Infrastructure.Repos
{
        ...
        ApplicationDbContext dbContext) : IAccount
    {
        ...
        public async Task<GeneralResponse> CreateSuperAdminAsync()
        {
            try
            {
                ...
                var supeAdmin = new CreateAccountRequestDTO()
                {
                    ...
                    Roles = roles,
                    Status = EnumUserStatus.Activated.ToString()
                };
        ...
        //public async Task<string> GeneratePdf(IFormFile pdfFile)
        public async Task<string> GeneratePdf()
        {
            // Initialize the PDF exporter
            var pdfExporter = new PdfExporter();

            // Sample data to be displayed in the PDF
            var data = new
            {
                Title = "Test PDF Document",
                Date = DateTime.Now,
                Message = "This is a sample PDF file generated by Magicodes.IE."
            };

...
namespace WebUIFinal.Pages.Batch
{
    public partial class DetailBatch
    {
        ...
        {
            var confirm = await _dialogService.Confirm($"Do you want to save?", "Save", new ConfirmOptions()
            {
                OkButtonText = "Yes",
                CancelButtonText = "No",
        ...
        async Task DeleteItemAsync(BatchEntity _batch)
        {
            try
            {
                var confirm = await _dialogService.Confirm($"Are you sure you want to delete this: {_batch.Id}?", "Delete", new ConfirmOptions()
                {
                    OkButtonText = "Yes",
                    CancelButtonText = "No",
                    AutoFocusFirstElement = true,

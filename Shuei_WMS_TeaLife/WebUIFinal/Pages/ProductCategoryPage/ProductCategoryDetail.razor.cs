...
namespace WebUIFinal.Pages.ProductCategoryPage
{
    public partial class ProductCategoryDetail
    {
        ...
        {
            var confirm = await _dialogService.Confirm($"Do you want to Save: {arg.CategoryName}?", "Product Category", new ConfirmOptions()
            {
                OkButtonText = "Yes",
                CancelButtonText = "No",
        ...
        async Task DeleteItemAsync(ProductCategory ProductCategory)
        {
            try
            {
                var confirm = await _dialogService.Confirm($"Are you sure you want to delete ProductCategory: {ProductCategory.CategoryName}?", "Delete ProductCategory", new ConfirmOptions()
                {
                    OkButtonText = "Yes",
                    CancelButtonText = "No",
                    AutoFocusFirstElement = true,

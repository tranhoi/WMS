...
namespace WebUIFinal.Pages.Account
{
    public partial class Permission
    {
        ...
        async Task EditItemAsync(string id)
        {
            ...
            _navigation.NavigateTo($"/addpermission/Edit Permission|{id}");
        ...
        {
            _navigation.NavigateTo("/addpermission/Create New Permission");
        ...
        async Task ViewItemAsync(string id)
        {
            ...
            _navigation.NavigateTo($"/addpermission/View Permission|{id}");
        }

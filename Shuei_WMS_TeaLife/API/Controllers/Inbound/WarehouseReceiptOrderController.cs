...
namespace API.Controllers.Inbound
{
    ...
    public class WarehouseReceiptOrderController : BaseController<Guid, WarehouseReceiptOrder>,IWarehouseReceiptOrder
    {
        ...
        public async Task<Result<WarehouseReceiptOrder>> InsertWarehouseReceiptOrder([Body] WarehouseReceiptOrderDto request) => await _repository.SWarehouseReceiptOrders.InsertWarehouseReceiptOrder(request);
        
        [HttpPost(ApiRoutes.WarehouseReceiptOrder.UpdateWarehouseReceiptOrder)]
        public async Task<Result<WarehouseReceiptOrder>> UpdateWarehouseReceiptOrder([Body] WarehouseReceiptOrderDto request) => await _repository.SWarehouseReceiptOrders.UpdateWarehouseReceiptOrder(request);

        [HttpGet(ApiRoutes.WarehouseReceiptOrder.GetReceiptOrderAsync)]
        public async Task<Result<WarehouseReceiptOrderDto>> GetReceiptOrderAsync(string receiptNo) => await _repository.SWarehouseReceiptOrders.GetReceiptOrderAsync(receiptNo);
